...
dataEnterpriseA = Datas.readerDatas(pathJson, 'json')
print('Nome das colunas da empresa A: ', dataEnterpriseA.__getColumns())
print('Quantidade de linhas totais da empresa A: ', dataEnterpriseA.quantityLines)
dataEnterpriseB = Datas.readerDatas(pathcsv, 'csv')
print('Nome das colunas da empresa B: ', dataEnterpriseB.__getColumns())
